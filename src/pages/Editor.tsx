  ...
  return (
    <div id="root" className="app-layout">
      ...
      <header className="header" style={{ padding: '0 16px', gap: '12px' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '12px', flex: '0 0 auto' }}>
          <div
            ...
            style={{
              ...
              boxShadow: '0 0 12px rgba(116,69,119,0.45)',
              transition: 'all 0.2s'
            }}
          >
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="rgb(240,233,182)" strokeWidth="2.5">
          ...
          <div style={{ display: 'flex', flexDirection: 'column', lineHeight: 1.2 }}>
            <input
              ...
              onFocus={e => e.target.style.borderBottomColor = 'rgb(116,69,119)'}
              onBlurCapture={e => e.target.style.borderBottomColor = 'transparent'}
            />
            <div style={{ display: 'flex', gap: '10px', marginTop: '1px' }}>
              <span
                style={{ fontSize: '11px', color: 'rgba(240,233,182,0.4)', cursor: 'pointer', fontFamily: "'DM Sans', system-ui, sans-serif" }}
                onClick={() => setIsShareModalOpen(true)}
              >
                Archivo
              </span>
              <span style={{ fontSize: '11px', color: 'rgba(240,233,182,0.4)', cursor: 'pointer' }}>Editar</span>
              <span
                style={{ fontSize: '11px', color: 'rgb(132,197,177)', cursor: 'pointer', fontWeight: 600 }}
                onClick={() => setIsShareModalOpen(true)}
              >
                ⇄ Compartir
              </span>
        ...
        {/* ── Grupo 2: Acciones principales (Guardar, KPI, Docs) ── */}
        <div style={{ display: 'flex', alignItems: 'center', gap: '6px', flex: '0 0 auto' }}>
          ...
          <button
            ...
            style={{
              ...btnBase,
              background: isSaving ? 'rgba(116,69,119,0.1)' : 'rgba(116,69,119,0.18)',
              borderColor: 'rgba(116,69,119,0.5)',
              color: 'rgb(240,233,182)',
              opacity: isSaving ? 0.6 : 1,
            }}
            onMouseEnter={e => { if (!isSaving) { e.currentTarget.style.background = 'rgba(116,69,119,0.35)'; e.currentTarget.style.transform = 'translateY(-1px)'; } }}
            onMouseLeave={e => { e.currentTarget.style.background = 'rgba(116,69,119,0.18)'; e.currentTarget.style.transform = 'none'; }}
          >
          ...
          <button
            ...
            title="Ver métricas KPI"
            style={{ ...btnBase, background: 'rgba(172,207,163,0.12)', borderColor: 'rgba(172,207,163,0.35)', color: 'rgb(130,165,120)' }}
            onMouseEnter={e => { e.currentTarget.style.background = 'rgba(172,207,163,0.25)'; e.currentTarget.style.transform = 'translateY(-1px)'; }}
            onMouseLeave={e => { e.currentTarget.style.background = 'rgba(172,207,163,0.12)'; e.currentTarget.style.transform = 'none'; }}
          >
            <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2">
          ...
          <button
            ...
            style={{ ...btnBase, background: 'rgba(132,197,177,0.12)', borderColor: 'rgba(132,197,177,0.35)', color: 'rgb(90,155,135)' }}
            onMouseEnter={e => { e.currentTarget.style.background = 'rgba(132,197,177,0.25)'; e.currentTarget.style.transform = 'translateY(-1px)'; }}
            onMouseLeave={e => { e.currentTarget.style.background = 'rgba(132,197,177,0.12)'; e.currentTarget.style.transform = 'none'; }}
          >
            <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2">
